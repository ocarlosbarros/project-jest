...
describe('2 - Verifica o usuário', () => {
  ...
  test('caso a requisicao seja rejeitada', async () => {
    fetchURL.mockRejectValue('Por algum motivo a requisição falhou!');
    expect(fetchURL()).rejects.toMatch('Por algum motivo a requisição falhou!');
